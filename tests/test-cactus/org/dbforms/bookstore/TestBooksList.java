...
public class TestBooksList extends AbstractHttpTestCase {
   ...
   public void testBooksList() throws Exception {
      ...
      list.add(new StaticData("fu_1", "/tests/testBOOKSList.jsp"));
      list.add(new StaticData("lang", "de"));
      list.add(new StaticData("source", "/bookstore/tests/testBOOKSList.jsp"));
      list.add(new StaticData("customEvent", ""));
      list.add(new StaticData("firstpos_1", "0%3A1%3A9-2%3A1%3A2"));
      list.add(new StaticData("lastpos_1", "0%3A1%3A1-2%3A1%3A1"));
      list.add(new StaticData("sort_1_0", "asc"));
      list.add(new StaticData("sort_1_1", "none"));
      list.add(new StaticData("sort_1_2", "none"));
      list.add(new StaticData("sort_1_3", "none"));
      list.add(new StaticData("k_1_0@root", "0%3A1%3A9-2%3A1%3A2"));
      list.add(new StaticData("k_1_1@root", "0%3A1%3A8-2%3A1%3A2"));
      list.add(new StaticData("k_1_2@root", "0%3A1%3A7-2%3A0%3A"));
      list.add(new StaticData("k_1_3@root", "0%3A1%3A6-2%3A1%3A2"));
      list.add(new StaticData("k_1_4@root", "0%3A1%3A5-2%3A1%3A2"));
      list.add(new StaticData("k_1_5@root", "0%3A1%3A4-2%3A1%3A2"));
      list.add(new StaticData("k_1_6@root", "0%3A1%3A3-2%3A1%3A2"));
      list.add(new StaticData("k_1_7@root", "0%3A1%3A2-2%3A1%3A1"));
      list.add(new StaticData("k_1_8@root", "0%3A1%3A1-2%3A1%3A1"));
      ...
      list.add(new StaticData("sort_1_0", "desc"));
      list.add(new StaticData("sort_1_1", "none"));
      list.add(new StaticData("sort_1_2", "none"));
      list.add(new StaticData("sort_1_3", "none"));
