...
public class ReflectionUtil {
	/** log4j category */
	private static Log logCat = LogFactory.getLog(ReflectionUtil.class);
	 ...
	 * @param methodName
	 *            the arguments classes for the object method
	 * @param argsTypes
	 *            the arguments values for the object constructor
	 * @param args
	 *            DOCUMENT ME!
	 * 
	...
	public static Object invoke(String className, String methodName,
			Class[] argsTypes, Object[] args) throws ClassNotFoundException,
			InstantiationException, IllegalAccessException,
			NoSuchMethodException, InvocationTargetException {
		Object i = newInstance(className);
		Method m = i.getClass().getDeclaredMethod(methodName, argsTypes);
	...
	public static Object newInstance(String className)
		...
		Class myClass = newClass(className);
	 ...
	 *            the object constructor arguments classes
	...
	public static void reflectClass(String name, Writer w) {
		try {
			reflectClass(newInstance(name), false, w);
		} catch (Exception e) {
