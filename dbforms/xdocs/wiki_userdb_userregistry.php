...
function ewiki_auth_userdb_userregistry($username, $password=NULL) {
   ...
   #-- get pw list
   $data = ewiki_database("GET", array("id"=>EWIKI_USERDB_USERREGISTRY));
...
function ewiki_page_userregistry($id, &$data, $action) {
   ...
   #-- save changes -------------------------------------------------------
   if ($user && $_REQUEST["userreg_store"]) {
      #-- check password
      $ok = true;
      ...
      if (empty($ue) && $user && $_REQUEST["userreg_store"]) {
         $ue =
         $_REQUEST["userreg_ue"] =
         array(
            $pw,
      ...
      if ($ok)  {  
         ...
         while ($retry--) {
            $data["version"]++;
            if ($ok = ewiki_database("WRITE", $data)) {
               break;
            }
         }
         if ($ok) {
   ...
   if ($_REQUEST["userreg_register"] && empty($ue)) {
      $o .= ewiki_t(<<< END
      <h4 align="center">_{New Account}</h4>
      <form action="$url" method="POST" enctype="multipart/form-data" accept-encoding="ISO-8859-1">
            <table>
               <tr>
                  ...
                  <td>
                     <input type="text" size="14" name="userreg_name" value="$user" /> 
                  </td>
               <tr>
               <tr>
                  <td align="right">
                  ...
                  <td>
                     <input type="password" name="new_pw" size="10" maxsize="12" value="$pw" />
                  </td>
               <tr>
               <tr>
                  <td align="right">
                  ...
                  <td>
                    <input type="password" name="new_pw2" size="10" maxsize="12" value="" /> 
                  </td>
               <tr>
               <tr>
                  <td>
            ...
            <input type="hidden" name="userreg_register" value="1">
      </form>
END
      );
   ...
   #-- view settings ----------------------------------------------------
   if ($user && $_REQUEST["userreg_login"]) {

      #-- edit <form>
      $o .= ewiki_t(<<< END
            <h4 align="center">_{Account Settings}</h4>
            <form action="$url" method="POST" enctype="multipart/form-data" accept-encoding="ISO-8859-1">
               <input type="hidden" name="userreg_name" value="$user">
               <input type="hidden" name="userreg_pw" value="$pw">
               <input type="hidden" name="userreg_login" value="1">
               <table>
                  <tr>
                     <td align="right">
                        _{change password}
                  ...
                  <tr>
                     ...
                     <td>
                        <input type="text" name="userreg_ue[2]" value="{$ue[2]}" />
                     </td>
                  </tr>
                  <tr>
                     <td  align="right">
                     ...
                     <td>
                        <input type="text" name="userreg_ue[3]" value="{$ue[3]}" />
                     </td>
                  </tr>
                  <tr>
                     <td colspan="2" align="center">
         ...
         <form action="$url" method="POST" enctype="multipart/form-data" accept-encoding="ISO-8859-1">
              <table>
               ...
               <tr>
                  ...
                  <td>
                     <input type="password" name="userreg_pw" size="10" maxsize="12" value="$pw" />
                  </td>
               <tr>
               <tr>
                  <td align="right">
                  ...
                  <td>
                     <input type="submit" name="userreg_register" value="_{create account}" />
                  </td>
               <tr>
            </table>
            </div>
