...
/**
 * This servlet generates a comma separated values file (CSV).
 * Data is read from the current dbForm, a Collection or a ResultSetVector
 * 
 * The template file is in the reports directory with a .cr extension
 * it consists of two lines of text, the first is a list of stirngs to use as header
 * the second a list of  comma separated field names. both lines must have the
 ...
 *
 * web.xml optional parameters
 * 	reportdirs       list of directories to search for report file
 *  reportMimeType   mime type to send to browser
 *
 * Parameters
 *   filename=xyz.csv           name the output file
 * 
...
public class StartServletCSV extends HttpServlet {
	private static Category logCat =
		Category.getInstance(StartServletCSV.class);
...
//	public static final String mimeType = "text/comma-separated-values;charset=UTF-8";
	...
	public void init() throws ServletException {
		...
		value = getServletConfig().getInitParameter(REPORTMIMETYPEPARAM);
