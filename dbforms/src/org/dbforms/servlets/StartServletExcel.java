...
/**
 * This servlet generates a Microsoft Excel xls file using POI.
 * Data is read from the current dbForm, a Collection or a ResultSetVector
 * 
 * The template file is in the reports directory with a .xr extension
 * it consists of one line of text, which is list of comma separated field names
 * 
 ...
 *
 * Parameters
 *   filename=xyz.xls           name the output file
 *   sheetname=first_page       name the worksheet
 * 
 ...
 *
 * Note: Setting column headings does not work.
 *
 * @author Neal Katz
 */
...
public class StartServletExcel extends HttpServlet {
	private static Category logCat =
		Category.getInstance(StartServletExcel.class);
	...
	public static void processReport(
		...
		} else {headerFields = reportFields;
		}
