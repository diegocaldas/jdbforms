...
public class DbDateFieldTag extends DbBaseInputTag
{
    ...
    public int doEndTag() throws javax.servlet.jsp.JspException
    {
        ...
        try
        {
            ...
            String value = ("true".equals(this.getHidden())) ? "<input type=\"hidden\" name=\"" : "<input type=\"text\" name=\"";
            ...
            if (!("true".equals(this.getHidden())) && ("true".equals(this.getUseJsCalendar())))
            {
                ...
                if ((jsCalendarDateFormat == null) && (this.format instanceof java.text.SimpleDateFormat))
                {
                ...
                tagBuf.append("setDateField(document.dbform['").append(getFormFieldName()).append("']);").append(" top.newWin = window.open('").append(request.getContextPath()).append("/dbformslib/jscal/calendar.html','cal','WIDTH=270,HEIGHT=280')\">").append("<IMG SRC=\"").append(request.getContextPath()).append("/dbformslib/jscal/calendar.gif\" WIDTH=\"32\" HEIGHT=\"32\" ").append(" BORDER=0  alt=\"Click on the Calendar to activate the Pop-Up Calendar Window.\">").append("</a>");
            }
