...
public class DbSearchTag extends AbstractDbBaseHandlerTag implements
	...
	public int doEndTag() throws javax.servlet.jsp.JspException {
		try {
			...
			String oldValue = ParseUtil.getParameter(request, paramNameBuf
					.toString());
			/*
			 * PG - 2005-11-13 We may want to hide this field
			 */
	...
	/*
	 * Must be overloaded to get the right fieldName in
