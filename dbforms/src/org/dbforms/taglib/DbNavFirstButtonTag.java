 ...
 * @author Joachim Peer
 */
public class DbNavFirstButtonTag extends AbstractDbBaseButtonTag
   ...
   public int doStartTag() throws javax.servlet.jsp.JspException {
      ...
      boolean isFirstPage = getParentForm()
                               .getResultSetVector()
                               .isFirstPage();
      ...
      try {
         ...
         //default: "disabled".equals(getDisabledBehaviour())
            ...
            String       tagName = EventType.EVENT_NAVIGATION_TRANSFER_FIRST
                                   + getTable()
                                        .getId() + "_"
