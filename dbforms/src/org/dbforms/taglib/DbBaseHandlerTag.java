...
public abstract class DbBaseHandlerTag extends TagSupportWithScriptHandler {
   private static Log logCat     = LogFactory.getLog(DbBaseHandlerTag.class
                                                     .getName());
    ...
    *
    * @param readOnlyStyleClass DOCUMENT ME!
    */
   ...
   public String getStyleClass() {
      boolean readonly = hasReadOnlySet() || getParentForm()
                                                .hasReadOnlySet();
   ...
   protected Object getFieldObject() {
      ...
      ResultSetVector res = getParentForm()
                               .getResultSetVector();
      ...
      if ((res != null) && (getField() != null)) {
         ...
         fieldValueObj = ParseUtil.getParameter((HttpServletRequest) pageContext
                                                .getRequest(),
                                                getFormFieldName());
         ...
         if (fieldValueObj == null) {
            ...
            fieldValueObj = (getEscaper() == null) ? fieldValueObj
                                                   : getEscaper()
                                                        .unescapeHTML((String) fieldValueObj);
         }
      }
   ...
   protected String getFieldValue() {
      ResultSetVector rsv = getParentForm()
                               .getResultSetVector();
      String          res = null;
      ...
      if ((getField() != null) && (rsv != null)) {
         ...
         if (s != null) {
            res = rsv.getCurrentRow()[getField()
                                         .getId()];
         }
      }
    ...
    * a jsp which contains many input fields, it may be desirable, in the
    * event of an error, to redisplay input data. (instead of refreshing the
    * fields from the DB) Currently dbforms implements this functionality with
    * INSERT fields only. The following describes the changes I've
    * implemented: - I've added a new attribute in the Form tag which sets the
    * functionality (redisplayFieldsOnError=true/false) - I've modified the
    * code below to handle the redisplay of previously posted information
    *
    * @return DOCUMENT ME!
    */
   ...
   protected String getFormattedFieldValue() {
      ...
      if (fieldValueObj == null) {
         ...
         // String constructor:
         if (fieldValueObj.getClass()
                                .isArray()
                   && "byte".equals(fieldValueObj.getClass().getComponentType().toString())) {
   ...
   protected void writeOutSpecialValues() throws JspException {
      try {
         pageContext.getOut()
                    .write(renderOldValueHtmlInputField());
   ...
   private String getFormFieldNameForCopyEvent() {
      boolean footerReached = getParentForm()
                                 .getFooterReached();
      getParentForm()
      ...
      getParentForm()
         .setFooterReached(footerReached);
