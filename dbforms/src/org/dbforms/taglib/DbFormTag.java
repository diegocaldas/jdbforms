...
public class DbFormTag
   ...
   public int doStartTag() {
      ...
      try {
         ...
         if (!Util.isNull(requestSqlFilterString)) {
            sqlFilterParams =
               DbFilterTag.getSqlFilterParams(request, this.getTable().getId());
         }
         ...
         if (navEvent == null) {
            ...
            if (!Util.isNull(gotoPrefix)) {
               ...
               Vector v =
                  ParseUtil.getParametersStartingWith(request, gotoPrefix);
         ...
         if (navEvent != null) {
            logCat.info(
               "about to process nav event:" + navEvent.getClass().getName());
            resultSetVector =
   ...
   */
   ...
   private StringBuffer generateJavascriptValidation() {
      if (isSubForm()) {
         ...
         ValidatorResources vr =
            (ValidatorResources) pageContext.getServletContext().getAttribute(
   ...
   public void doCatch(Throwable t) throws Throwable {
      ...
      logCat.error(
         "DbFormTag.doCatch called - " + t.toString() + "\n" + sw.toString());
      throw t;
   }
