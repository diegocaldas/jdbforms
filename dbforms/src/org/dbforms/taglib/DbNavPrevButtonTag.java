      ...
      implements javax.servlet.jsp.tagext.TryCatchFinally
{
   ...
   public int doStartTag() throws javax.servlet.jsp.JspException
   {
      ...
      if (getParentForm().getFooterReached() && ResultSetVector.isNull(getParentForm().getResultSetVector()))
      {
      ...
      try
      {
	      ...
	      //default: "disabled".equals(getDisabledBehaviour())
	         ...
	         String       tagName = EventType.EVENT_NAVIGATION_TRANSFER_PREV + getTable().getId() + "_" + Integer.toString(getUniqueID());
