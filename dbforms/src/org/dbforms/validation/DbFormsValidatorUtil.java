...
public class DbFormsValidatorUtil
{
    ...
    * @return        <code>StringBuffer</code> : The complete javascript validation section to include in response.
     **********************************************************************************************/
    public static StringBuffer getJavascript(String formName, Locale locale, Hashtable fieldsName, ValidatorResources resources, String javascriptValidationSrcFile, DbFormsErrors errors)
    {
