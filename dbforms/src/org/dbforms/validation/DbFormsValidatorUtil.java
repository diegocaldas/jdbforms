...
public class DbFormsValidatorUtil {
   static Log logCat = LogFactory.getLog(DbFormsValidatorUtil.class.getName());
      ...
      for (Iterator formIterator = formNames.iterator();
         ...
         if ((form = resources.get(locale, formName)) != null) {
            ...
            for (Iterator i = form.getFields()
               ...
               for (Iterator x = field.getDependencies()
                                      .iterator(); x.hasNext();) {
                  Object o = x.next();
      ...
      Collections.sort(lActions,
            ...
            public int compare(Object o1,
               ...
               if (((va1.getDepends() == null)
                  ...
                  return va1.getDependencies()
                            .size() - va2.getDependencies()
                                         .size();
               }
            }
         });
                     ...
                     while (enum.hasMoreElements()) {
                        ...
                        if (field.getKey()
                           ...
                           */
                           ...
                           results.append(" this.dbforms_" + jscriptVar
                                          + " = new Array(\"" + fieldName
                                          + "\", \"" + message + "\", ");
                           ...
                           for (Iterator iVars = hVars.keySet()
                                                      .iterator();
                                      iVars.hasNext();) {
   ...
   * @return        <code>String</code> : Message resolve.
   ...
   // ***
   //*********************************************************************************************
   private static String getJavascriptBegin(String formName,
                                            String methods) {
