...
public class NavEventFactoryImpl extends NavEventFactory
{
    ...
    * @return a new navigation event
    */
   public NavigationEvent createEvent(String action, HttpServletRequest request, 
                                      DbFormsConfig config, Table table)
   {
                                          ...
                                          String positionString)
   {
      ...
      {
         table, request, config, positionString
      };
                                          ...
                                          String whereClause, String tableList)
   {
      ...
      Object[]  constructorArgs = new Object[] 
      {
         table, request, config, whereClause, tableList
      };
   ...
   {
      addEventInfo(
               new EventInfo(EventType.EVENT_NAVIGATION_NEW, 
                             "org.dbforms.event.NavNewEvent"));
      addEventInfo(
               new EventInfo(EventType.EVENT_NAVIGATION_COPY, 
                             "org.dbforms.event.NavCopyEvent"));
      addEventInfo(
               new EventInfo(EventType.EVENT_NAVIGATION_GOTO, 
                             "org.dbforms.event.datalist.GotoEvent"));
      addEventInfo(
               new EventInfo(EventType.EVENT_NAVIGATION_FIRST, 
                             "org.dbforms.event.datalist.NavFirstEvent"));
      addEventInfo(
               new EventInfo(EventType.EVENT_NAVIGATION_LAST, 
                             "org.dbforms.event.datalist.NavLastEvent"));
      addEventInfo(
               new EventInfo(EventType.EVENT_NAVIGATION_NEXT, 
