        ...
        while (enum.hasMoreElements())
        {
            ...
            if (curField != null)
            {
                ...
                if (fieldType == FieldTypes.BLOB)
                {
                    ...
                    logCat.info("we are looking for fileholder with name: f_" + tableId + "_" + keyId + "_" + curField.getId());
                    value = ParseUtil.getFileHolder(request, "f_" + tableId + "_" + keyId + "_" + curField.getId());
                    logCat.info("and found a value=" + value);
                }
                else if (fieldType == FieldTypes.DISKBLOB)
                {
                    FileHolder fileHolder = ParseUtil.getFileHolder(request, "f_" + tableId + "_" + keyId + "_" + curField.getId());
