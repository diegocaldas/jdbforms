	...
	*/
	...
	public ResultSetVector processEvent(	FieldValue[] childFieldValues,
		...
		if (Util.isNull(whereClause)) {
			// Standard way  
			int compMode = (!Util.isNull(position)) ? Constants.COMPARE_INCLUSIVE : Constants.COMPARE_NONE;
			...
			// free form select
			return table.doFreeFormSelect(table.getFields(), whereClause, tableList, count, con);
		}
	}
}
