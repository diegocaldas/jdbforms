 ...
 */
public class GotoEventImpl extends GotoEvent
{
    // logging category for this class;
    static Category logCat = Category.getInstance(GotoEventImpl.class.getName());
    ...
    * </p>
    */
    public GotoEventImpl(String action, HttpServletRequest request, DbFormsConfig config)
    {
        this.config = config;
     ...
     *  instanciated
     */
    public GotoEventImpl(String position, Table table)
    {
        this.table = table;
