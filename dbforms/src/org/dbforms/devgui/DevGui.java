...
public class DevGui extends javax.swing.JFrame implements ActionListener
{
    ...
    public DevGui()
    {
        ...
        if (dbFormsHomeStr != null)
        {
            ...
            if (dbFormsHome.isDirectory() && dbFormsHome.canRead())
            {
                ...
                jTabbedPane1.setToolTipTextAt(0, "specify web application location and URI");
                jTabbedPane1.setTitleAt(1, "(2) Database");
                jTabbedPane1.setToolTipTextAt(1, "set database properties like JDBC driver, username");
                jTabbedPane1.setTitleAt(2, "(3) XML Config");
                jTabbedPane1.setToolTipTextAt(2, "automatically generate dbforms config file");
            ...
            {
                quickQuit("DBFORMS_HOME is set to \"" + dbFormsHomeStr + "\", which is not a valid accessible directory.", 1);
            }
        }
        else
        {
            quickQuit("Pleases set the environment variable DBFORMS_HOME to the root of your unzipped DbForms-Distribution! Check manual for more info.", 1);
        }
    }
    ...
    private void exitProject()
    {
        ...
        {
            int answer = JOptionPane.showOptionDialog(this, "Your project data has not been not saved.", "Ooops", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE, null, new String[] 
            {
