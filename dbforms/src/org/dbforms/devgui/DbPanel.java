...
public class DbPanel extends PropertyPanel implements ActionListener
{
   ...
   { //GEN-BEGIN:initComponents
      ...
      b_testConnection.setToolTipText(
         "Check if the configuration provided in this dialog is correct.");
   ...
   private void testConnection()
   {
      ...
      try
      {
         con = XMLConfigGenerator.createConnection(jdbcDriver, jdbcURL,
               username, password);

         if (con == null)
         {
            JOptionPane.showMessageDialog(this, "No connection", "db failure",
               JOptionPane.ERROR_MESSAGE);
         }
         else
         {
            JOptionPane.showMessageDialog(this,
               "Database connection successfully installed.", "Success",
      ...
      catch (Exception e)
      {
         if (con == null)
         {
            JOptionPane.showMessageDialog(this, "Error:" + e.toString(),
               "db failure", JOptionPane.ERROR_MESSAGE);
         }
