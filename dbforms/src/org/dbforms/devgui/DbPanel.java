...
public class DbPanel extends PropertyPanel implements ActionListener
{
    ...
    private void testConnection()
    {
        ...
        try
        {
            ...
            if (con == null)
            {
                JOptionPane.showMessageDialog(this, "No connection", "db failure", JOptionPane.ERROR_MESSAGE);
            }
            else
            {
        ...
        catch (Exception e)
        {
            if (con == null)
            {
                JOptionPane.showMessageDialog(this, "Error:" + e.toString(), "db failure", JOptionPane.ERROR_MESSAGE);
            }
