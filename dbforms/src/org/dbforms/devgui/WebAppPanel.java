...
public class WebAppPanel extends PropertyPanel implements ActionListener
{
   ...
   { //GEN-BEGIN:initComponents
      ...
      b_chooseRoot.setToolTipText(
         "Choose the local root directory of your web application.");
      ...
      b_chooseRoot.setToolTipText(
         "Test the application. Web server must be running!");
   ...
   public void actionPerformed(ActionEvent ev)
   {
      if (ev.getSource() == b_chooseRoot)
      {
         ...
         {
            tf_webAppRoot.setText(dlg_fileChooser.getSelectedFile()
                                                 .getAbsolutePath());
