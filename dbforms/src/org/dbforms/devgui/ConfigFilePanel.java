...
public class ConfigFilePanel extends PropertyPanel implements ActionListener
{
   ...
   */
   ...
   private void initComponents2()
   {
      ...
      b_generate.setToolTipText(
         "Generate raw content of config-file by quering the database you defined in tab \"Database properties\".");
      ...
      cb.addItemListener(new java.awt.event.ItemListener()
         {
            public void itemStateChanged(java.awt.event.ItemEvent e)
            {
               projectData.setProperty(propertyName,
                  cb.isSelected() ? TRUESTRING : FALSESTRING);
            }
         });
   }
   ...
   */
   ...
   { //GEN-BEGIN:initComponents
      ...
      cb_autocommit.setText(
         "Use autocommit mode while reading metadata (recommended).");
      gridBagConstraints              = new java.awt.GridBagConstraints();
      gridBagConstraints.gridx        = 0;
      ...
      cb_stdTypeNames.setText(
         "Try to write standard type names for unknown field types into xml config file.");
      gridBagConstraints              = new java.awt.GridBagConstraints();
      gridBagConstraints.gridx        = 0;
   ...
   private void rb_catalog_comboboxActionPerformed(
 ...
 /*
   ...
   */
   ...
   public void setNewProjectData(ProjectData projectData)
   {
      ...
      cb_examine_tables.setSelected(TRUESTRING.equalsIgnoreCase(
            projectData.getProperty(EXAMINE_TABLES)));
      cb_examine_views.setSelected(TRUESTRING.equalsIgnoreCase(
            projectData.getProperty(EXAMINE_VIEWS)));
      cb_examine_systabs.setSelected(TRUESTRING.equalsIgnoreCase(
            projectData.getProperty(EXAMINE_SYSTABS)));
