 ...
 */
    ...
    private void initComponents2()
    {
        ...
        addJRadioButtonActionListener(rb_forkey_getImportedKeys, FOREIGNKEY_DETECTION, USE_GETIMPORTEDKEYS);
        addJRadioButtonActionListener(rb_forkey_getCrossReferences, FOREIGNKEY_DETECTION, USE_GETCROSSREFERENCES);
        addJRadioButtonActionListener(rb_forkey_deactivated, FOREIGNKEY_DETECTION, DEACTIVATED);
     ...
     */
    protected void addJRadioButtonActionListener(final JRadioButton rb, final String propertyName, final String propertyValue)
    {
...
*/
 ...
 try to read catalog and schema names from database and fill corresponding combo boxes
*/
    private void loadCatalogAndSchemaNames(java.awt.event.ActionEvent evt)
    { //GEN-FIRST:event_loadCatalogAndSchemaNames
    ...
    public void setNewProjectData(ProjectData projectData)
    {
        ...
        // autocommit mode:
        cb_include_catalogname.setSelected(TRUESTRING.equalsIgnoreCase(projectData.getProperty(INCLUDE_CATALOGNAME)));
        cb_include_schemaname.setSelected(TRUESTRING.equalsIgnoreCase(projectData.getProperty(INCLUDE_SCHEMANAME)));
        cb_autocommit.setSelected(TRUESTRING.equalsIgnoreCase(projectData.getProperty(AUTOCOMMIT_MODE)));

        cb_stdTypeNames.setSelected(TRUESTRING.equalsIgnoreCase(projectData.getProperty(WRITE_STD_TYPENAMES)));


        // set checkboxes for examination of tables, views and system tables:
        cb_examine_tables.setSelected(TRUESTRING.equalsIgnoreCase(projectData.getProperty(EXAMINE_TABLES)));
        cb_examine_views.setSelected(TRUESTRING.equalsIgnoreCase(projectData.getProperty(EXAMINE_VIEWS)));
        cb_examine_systabs.setSelected(TRUESTRING.equalsIgnoreCase(projectData.getProperty(EXAMINE_SYSTABS)));
    ...
    public void actionPerformed(ActionEvent ev)
    {
        if (ev.getSource() == b_generate)
        {
            ...
            if (!"".equals(configFile))
            {
                ...
                try
                {
                    String result = XMLConfigGenerator.createXMLOutput(projectData, true);
