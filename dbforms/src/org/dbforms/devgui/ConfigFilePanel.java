...
private EditorPanel panel_editor; 
        ...
        private void initComponents2(){
			...
			add(BorderLayout.CENTER, panel_editor);
                        ...
                        addJRadioButtonActionListener(rb_catalog_combobox, CATALOG_SELECTION, SELECTION);
                        
                        addJRadioButtonActionListener(rb_schema_all,                SCHEMA_SELECTION, ALL);                       
                        addJRadioButtonActionListener(rb_schema_combobox, SCHEMA_SELECTION, SELECTION);
                        
                        addJRadioButtonActionListener(rb_table_all,                    TABLE_SELECTION,ALL);
                        addJRadioButtonActionListener(rb_table_textfield,         TABLE_SELECTION,SELECTION);
  ...
  //                      catalogList.setSelectedIndex(0);
   ...
   //                     projectData.setProperty(SCHEMA,(String)schemaList.getItemAt(0));
        ...
        protected void addJRadioButtonActionListener(final JRadioButton rb, final String propertyName,
      ...
      protected void addCheckBoxItemListener(final JCheckBox cb,final String propertyName) {
            cb.addItemListener(new java.awt.event.ItemListener() {
                       public void itemStateChanged(java.awt.event.ItemEvent e){
		             projectData.setProperty(propertyName, cb.isSelected() ? TRUESTRING : FALSESTRING );
			}
            });
        }
     ...
     */
        private void initComponents() {//GEN-BEGIN:initComponents
            ...
            panel_top.add(tf_tableNamePattern, gridBagConstraints1);
            ...
            jPanel2.add(tf_configFile, gridBagConstraints2);
            ...
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            gridBagConstraints1.weightx = 1.0;
            panel_top.add(jPanel2, gridBagConstraints1);
            ...
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            panel_top.add(rb_catalog_all, gridBagConstraints1);
            ...
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            panel_top.add(rb_schema_all, gridBagConstraints1);
            ...
            gridBagConstraints1.gridy = 7;
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            panel_top.add(rb_table_all, gridBagConstraints1);
            ...
            gridBagConstraints1.gridy = 7;
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            panel_top.add(rb_table_textfield, gridBagConstraints1);
            ...
            gridBagConstraints1.gridwidth = 4;
            gridBagConstraints1.fill = java.awt.GridBagConstraints.HORIZONTAL;
            panel_top.add(jSeparator1, gridBagConstraints1);
            ...
            gridBagConstraints1.gridwidth = 4;
            gridBagConstraints1.fill = java.awt.GridBagConstraints.HORIZONTAL;
            panel_top.add(jSeparator3, gridBagConstraints1);
            ...
            gridBagConstraints1.gridwidth = 4;
            gridBagConstraints1.fill = java.awt.GridBagConstraints.HORIZONTAL;
            panel_top.add(jSeparator4, gridBagConstraints1);
            ...
            gridBagConstraints1.gridy = 5;
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            panel_top.add(rb_catalog_combobox, gridBagConstraints1);
            ...
            gridBagConstraints1.gridy = 6;
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            panel_top.add(rb_schema_combobox, gridBagConstraints1);
            ...
            gridBagConstraints1.gridwidth = 4;
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            panel_top.add(cb_autocommit, gridBagConstraints1);
            ...
            gridBagConstraints1.gridwidth = 4;
            gridBagConstraints1.fill = java.awt.GridBagConstraints.HORIZONTAL;
            panel_top.add(jPanel4, gridBagConstraints1);
            ...
            gridBagConstraints1.fill = java.awt.GridBagConstraints.HORIZONTAL;
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            panel_top.add(jSeparator5, gridBagConstraints1);
            ...
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            gridBagConstraints1.weightx = 1.0;
            panel_top.add(catalogList, gridBagConstraints1);
            ...
            gridBagConstraints1.anchor = java.awt.GridBagConstraints.WEST;
            gridBagConstraints1.weightx = 1.0;
            panel_top.add(schemaList, gridBagConstraints1);
        ...
        private void rb_catalog_comboboxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rb_catalog_comboboxActionPerformed
	  ...
	  String password = projectData.getProperty("password");
          ...
          try {
	       ...
	       DatabaseMetaData dbmd = con.getMetaData();
                ...
                if (catalogs.size() == 0) catalogs.add(" --- no catalogs found ---");
                catalogList.setModel(new DefaultComboBoxModel(catalogs));
                catalogList.setSelectedIndex(0);
                projectData.setProperty(CATALOG,(String)catalogList.getItemAt(0));
                ...
                if (schemas.size() == 0) schemas.add("--- no schemas found ---");
                schemaList.setModel(new DefaultComboBoxModel(schemas));
                schemaList.setSelectedIndex(0);
                projectData.setProperty(SCHEMA,(String)schemaList.getItemAt(0));
					...
					tf_configFile.setText( FileNameTool.normalize(webAppRoot)  + "WEB-INF" + parent.getFileSeparator() );
                        ...
                        if (ALL.equalsIgnoreCase(projectData.getProperty(TABLE_SELECTION)))
                            ...
                            rb_table_textfield.setSelected(true);
                                      ...
                                      // autocommit mode:
                        cb_include_catalogname.setSelected( TRUESTRING.equalsIgnoreCase(
                                        projectData.getProperty(INCLUDE_CATALOGNAME )));
                        cb_include_schemaname.setSelected(TRUESTRING.equalsIgnoreCase(
                                        projectData.getProperty(INCLUDE_SCHEMANAME )));
                        ...
                        cb_examine_views.setSelected(
                            TRUESTRING.equalsIgnoreCase(projectData.getProperty(EXAMINE_VIEWS)));
                        cb_examine_systabs.setSelected(
                            TRUESTRING.equalsIgnoreCase(projectData.getProperty(EXAMINE_SYSTABS)));
