...
public class JDBCDataHelper {
   ...
   private static Log logCat = LogFactory.getLog(JDBCDataHelper.class.getName());
    ...
    * @param blobStrategy DOCUMENT ME!
    *
    * @throws SQLException DOCUMENT ME!
    */
   public static void fillWithData(PreparedStatement ps,
      ...
      switch (fieldType) {
            ...
            if (value == null) {
               ...
               if (blobStrategy == Table.BLOB_CLASSIC) {
                  ...
                  try {
                     ...
                     throw new SQLException("error storing BLOB in database (BLOB_CLASSIC MODE) - "
                                            + ioe.toString(), null, 2);
                  }
               }
         ...
         case FieldTypes.DISKBLOB:
            ps.setObject(col,
                         (escaper == null) ? value
                                           : escaper.escapeJDBC((String) value),
                         FieldTypes.CHAR);
