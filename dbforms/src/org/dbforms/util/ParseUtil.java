...
public class ParseUtil
{
     ...
     */
    public static InputStream getFileInputStream(ServletRequest request, String name)
    {
        MultipartRequest multipartRequest = (MultipartRequest) request.getAttribute("multipartRequest");
    ...
    /**
    */
    public static Vector getParametersStartingWith(ServletRequest request, String str)
    {
        MultipartRequest multipartRequest = (MultipartRequest) request.getAttribute("multipartRequest");
    ...
    /**
    */
    public static String getFirstParameterStartingWith(ServletRequest request, String str)
    {
        MultipartRequest multipartRequest = (MultipartRequest) request.getAttribute("multipartRequest");
    ...
    */
    public static String getEmbeddedStringWithoutDots(String str, int afterDelims, char delim)
    {
        int lastIndex = 0;
