...
public class ParseUtil {
	...
	public static Enumeration getParameterNames(HttpServletRequest request) {
		...
		MultipartRequest multipartRequest =
			(MultipartRequest) request.getAttribute("multipartRequest");
	...
	/**
	*/
	public static Vector getParametersStartingWith(
		HttpServletRequest request,
		String str) {
		MultipartRequest multipartRequest =
			(MultipartRequest) request.getAttribute("multipartRequest");
	...
	/**
	*/
	public static String getFirstParameterStartingWith(
		HttpServletRequest request,
		String str) {
		MultipartRequest multipartRequest =
			(MultipartRequest) request.getAttribute("multipartRequest");
	...
	*/
	public static String getEmbeddedString(
		String str,
		int afterDelims,
		char delim) {
