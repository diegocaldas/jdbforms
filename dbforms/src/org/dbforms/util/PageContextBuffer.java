...
public class PageContextBuffer extends PageContext {
   ...
   private org.apache.commons.el.VariableResolverImpl variableResolver = new org.apache.commons.el.VariableResolverImpl(this);
   ...
   public void forward(String relativeURLPath)
      ...
      if (relativeURLPath == null) {
         throw new ServletException("[PageContext.forward()] Got 'null' URL - Probably caused "
   ...
   public void include(String relativeURLPath)
                throws ServletException, IOException {
      if (relativeURLPath == null) {
         throw new ServletException("[PageContext.include()] Got 'null' URL. Probably caused "
                                    + " by a non-existent Request Time Attribute Value.");
      }
      ...
      if (requestDispatcher == null) {
         ...
         if (is == null) {
            throw new ServletException("[PageContext.include()] Unable to obtain include resource "
                                       + relativeURLPath);
         }
