...
public class TimeUtil {
   ...
   private static void splitDate(final String format, StringBuffer sDate, StringBuffer sTime) {
      sDate.setLength(0);
      sTime.setLength(0);
   ...
   private synchronized static long saveParseTime(final SimpleDateFormat format, String formatString, String s) {
      Date d = null;
      if (!Util.isNull(s)) {
         if (!Util.isNull(formatString)) {
            format.applyPattern(formatString);
