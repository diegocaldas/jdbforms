...
public class PrintfFormat {
	...
	protected PrintfFormat(Locale locale) {
		this.locale = locale;
	...
	private class ConversionSpecification {
		...
		/**
		 * Format an Date argument using this conversion
		 * specification.
	...
	protected void setFmtArg(String fmtArg) throws IllegalArgumentException {
		formatCount = 0;
		int ePos = 0;
