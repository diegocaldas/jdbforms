...
{
    static Category logCat = Category.getInstance(MultipartRequest.class.getName()); // logging category for this class
        ...
        while ((part = parser.readNextPart()) != null)
        {
            ...
            else if (part.isFile())
            {
                ...
                if (fileName != null)
                {
                    ...
                    FileHolder fileHolder = new FileHolder(fileName, filePart.getContentType(), filePart.getInputStream(), true, maxPostSize);
