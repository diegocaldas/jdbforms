...
public class TestBooksSingle extends HttpTestCase
{
	...
	public void testBooksSingle() throws Exception
	{
		...
		list.add(new KeyValuePair("source", "/bookstore/tests/testBOOKSSingle.jsp"));
		list.add(new KeyValuePair("customEvent", ""));
		list.add(new KeyValuePair("firstpos_1", "0%3A1%3A2-2%3A1%3A1-3%3A22%3ADas+Foucaltsche+Pendel"));
		list.add(new KeyValuePair("lastpos_1", "0%3A1%3A2-2%3A1%3A1-3%3A22%3ADas+Foucaltsche+Pendel"));
		list.add(new KeyValuePair("ac_next_1", "next"));
		list.add(new KeyValuePair("k_1_0@root", "0%3A1%3A2-2%3A1%3A1-3%3A22%3ADas+Foucaltsche+Pendel"));
		post("http://localhost/bookstore/servlet/control", list);
		printResponse();
		...
		list.add(new KeyValuePair("lastpos_1", "0%3A1%3A3-2%3A1%3A2-3%3A30%3AHijacking+through+the+Galaxy+1"));
		list.add(new KeyValuePair("ac_next_1", "next"));
		...
		list.add(new KeyValuePair("source", "/bookstore/tests/testBOOKSSingle.jsp"));
		list.add(new KeyValuePair("customEvent", ""));
		list.add(new KeyValuePair("firstpos_1", "0%3A1%3A4-2%3A1%3A2-3%3A30%3AHijacking+through+the+Galaxy+2"));
		list.add(new KeyValuePair("lastpos_1", "0%3A1%3A4-2%3A1%3A2-3%3A30%3AHijacking+through+the+Galaxy+2"));
		list.add(new KeyValuePair("ac_next_1", "next"));
		list.add(new KeyValuePair("k_1_0@root", "0%3A1%3A4-2%3A1%3A2-3%3A30%3AHijacking+through+the+Galaxy+2"));
		post("http://localhost/bookstore/servlet/control", list);
		printResponse();
		...
		list.add(new KeyValuePair("lastpos_1", "0%3A1%3A5-2%3A1%3A2-3%3A30%3AHijacking+through+the+Galaxy+3"));
		list.add(new KeyValuePair("ac_next_1", "next"));
		...
		list.add(new KeyValuePair("source", "/bookstore/tests/testBOOKSSingle.jsp"));
		list.add(new KeyValuePair("customEvent", ""));
		list.add(new KeyValuePair("firstpos_1", "0%3A1%3A6-2%3A1%3A2-3%3A30%3AHijacking+through+the+Galaxy+4"));
		list.add(new KeyValuePair("lastpos_1", "0%3A1%3A6-2%3A1%3A2-3%3A30%3AHijacking+through+the+Galaxy+4"));
		list.add(new KeyValuePair("ac_next_1", "next"));
		list.add(new KeyValuePair("k_1_0@root", "0%3A1%3A6-2%3A1%3A2-3%3A30%3AHijacking+through+the+Galaxy+4"));
		post("http://localhost/bookstore/servlet/control", list);
		printResponse();
		...
		list.add(new KeyValuePair("lastpos_1", "0%3A1%3A7-2%3A0%3A-3%3A15%3ATest+null+value"));
		list.add(new KeyValuePair("ac_next_1", "next"));
