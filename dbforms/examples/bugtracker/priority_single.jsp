   ...
   <tr>
        ...
        <td align="right">
         		...
         		<request:isuserinrole role="bug_admin" value="true"> 
  		      		...
  		      		<a href="priority_list.jsp">[<db:message key="menu.list.displayname"/>]</a> 
...
<db:dbform 		tableName="priority" 
				maxRows="1" 
				followUp="/priority_single.jsp" 
				formValidatorName="Priority" 
...
<db:header>
<h1><db:message key="priorityForm.title"/></h1>
</db:header> 
...
<center>
	<db:insertButton caption="priorityForm.button.addthisone"/>
</center>
...
<h5 style="color:#ff3333">using DbForms-Error.xml for error messages </h5>
