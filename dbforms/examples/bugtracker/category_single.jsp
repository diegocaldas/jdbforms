...
<a href="category_list.jsp">[List]</a>
...
<db:dbform tableName="category" maxRows="1" followUp="/category_single.jsp" autoUpdate="false">
<db:header>
<h1>category</h1>
</db:header>
<db:errors/>
...
<br/>
<center>
<db:insertButton caption="Create new category"/>
</center>
</db:body>
<db:footer>
