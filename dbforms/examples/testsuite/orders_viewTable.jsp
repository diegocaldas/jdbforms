...
<html xmlns:db="http://www.wap-force.net/dbforms">
    ...
    <body bgcolor="#99CCFF">
        ...
        <db:dbform autoUpdate="false" followUp="/orders_viewTable.jsp" maxRows="5" tableName="orders">
            <db:header>
          <table align="center" >
                ...
                <tr bgcolor="#CECECE">
                    <td>
                        <table>
                            <tr>
                                <td>
                                          <INPUT type="text" name="<%= searchFieldNames_orders.get("customer_id") %>" size="10" ></td>
                                <td>
                                          <INPUT type="radio" name="<%= searchFieldModeNames_orders.get("customer_id") %>" checked value="and" >AND</td>
                            </tr>
                            <tr>
                                <td>
                                          <INPUT type="checkbox" name="<%= searchFieldAlgorithmNames_orders.get("customer_id") %>" value="weak" size="10" > Weak</td>
                                <td>
                                          <INPUT type="radio" name="<%= searchFieldModeNames_orders.get("customer_id") %>" value="or" >OR</td>
                            </tr>
                        </table>
                    </td>
                    <td>&nbsp;</td>
          ...
          <td><%= currentRow_orders.get("customer_id") %>&nbsp;</td><td><%= currentRow_orders.get("service_id") %>&nbsp;</td><td><%= currentRow_orders.get("orderdate") %>&nbsp;</td><td><a href="<db:linkURL href="/orders_single.jsp" tableName="orders" position="<%= position_orders %>"/>" ><IMG src="edit.gif" border="0" > </a></td>
                <td>
