...
<html xmlns:db="http://www.wap-force.net/dbforms">
    ...
    <body bgcolor="#99CCFF">
        ...
        <db:dbform autoUpdate="false" followUp="/priority_viewTable.jsp" maxRows="5" tableName="priority">
            <db:header>
          <table align="center" >
                ...
                <tr bgcolor="#CECECE">
                    <td>
                        <table>
                            <tr>
                                <td>
                                          <INPUT type="text" name="<%= searchFieldNames_priority.get("id") %>" size="10" ></td>
                                <td>
                                          <INPUT type="radio" name="<%= searchFieldModeNames_priority.get("id") %>" checked value="and" >AND</td>
                            </tr>
                            <tr>
                                <td>
                                          <INPUT type="checkbox" name="<%= searchFieldAlgorithmNames_priority.get("id") %>" value="weak" size="10" > Weak</td>
                                <td>
                                          <INPUT type="radio" name="<%= searchFieldModeNames_priority.get("id") %>" value="or" >OR</td>
                            </tr>
                        </table>
                    </td>
                    <td>&nbsp;</td>
          ...
          <td><a href="<db:linkURL href="/priority_single_ro.jsp" tableName="priority" position="<%= position_priority %>"/>" ><%= currentRow_priority.get("id") %></a>&nbsp;</td><td><%= currentRow_priority.get("shortname") %>&nbsp;</td><td><%= currentRow_priority.get("description") %>&nbsp;</td><td><a href="<db:linkURL href="/priority_single.jsp" tableName="priority" position="<%= position_priority %>"/>" ><IMG src="edit.gif" border="0" > </a></td>
                <td>
                ...
                <center>
                    <db:insertButton caption="Nuovo priority"/>
                </center>
            </db:body>
            <db:footer>
          </table>
