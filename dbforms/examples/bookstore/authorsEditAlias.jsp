<html>
   ...
   <body >
      <db:dbform autoUpdate="false" 
                 followUp="/authorsEditAlias.jsp" 
                 maxRows="1" 
                 tableName="AUTHORVIEW"
      >
         <h1 align="center">Edit authors using alias</h1>
         <db:header/>
         <db:errors/>
         <db:body>
         ...
         <db:footer>
            ...
            <tr class="button">
               <td colspan="2" style="text-align:center">
                 <db:gotoButton style="width:200" caption="Back to list" destination="/authorsListAlias.jsp"/>
               </td>
            </tr>
            </table>
         </db:footer>
