<html>
   ...
   <body>
      <% int i=1; %>			
      <h1 align="center">List of authors using alias</h1>
      <db:dbform tableName="AUTHORVIEW" followUp="authorsList.jsp" autoUpdate="false" >
	      	<db:header>
	             <db:errors/>			
	             ...
	             <table class="fixed" align="center" style="width:800px">
	            	...
	            	<tr class="button">
	                	<td colspan="4" style="text-align:right">
	                     ...
	                     <db:gotoButton destination="/authorsEditAlias.jsp"  caption="Edit" destTable="AUTHORVIEW" keyToKeyToDestPos="currentRow"  />
	                   </td>
	                </tr>
	             </table>      
	       </db:footer>
