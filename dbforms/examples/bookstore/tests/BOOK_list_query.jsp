...
<db:dbform multipart="false" autoUpdate="false" followUp="/tests/BOOK_list.jsp" maxRows="*" tableName="BOOK_NEW">
<db:header>
...
<db:body allowNew="false"><tr class="<%= (i++%2==0) ? "clsOddDataTableRow" : "clsEvenDataTableRow" %>"><td><a href="<db:linkURL href="/tests/BOOK_single.jsp" tableName="BOOK" position="<%= position_BOOK_NEW %>"/>" ><%= currentRow_BOOK_NEW.get("BOOK_ID") %></a>&nbsp;</td>
<td><%= currentRow_BOOK_NEW.get("ISBN") %>&nbsp;</td>
<td><%= currentRow_BOOK_NEW.get("AUTHOR_ID") %>&nbsp;</td>
<td><%= currentRow_BOOK_NEW.get("TITLE") %>&nbsp;</td>
</tr>
</db:body>
<db:footer></table>     
<center>
<hr width="400"/>
<db:navNewButton styleClass="clsButtonStyle" followUp="/tests/BOOK_single.jsp" caption="Insert new ..."/>
</center>
</db:footer>
</db:dbform>
</body>
