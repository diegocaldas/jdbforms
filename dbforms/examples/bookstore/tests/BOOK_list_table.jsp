...
<head>
<db:base/>
<title>List --- file: BOOK_list_table.jsp</title>
...
<db:dbform multipart="false" autoUpdate="false" followUp="/tests/BOOK_list_table.jsp" maxRows="*" tableName="BOOK">
<db:header>
...
<db:body allowNew="false"><tr class="<%= (i++%2==0) ? "clsOddDataTableRow" : "clsEvenDataTableRow" %>"><td><a href="<db:linkURL href="/tests/BOOK_single.jsp" tableName="BOOK" position="<%= position_BOOK %>"/>" ><%= currentRow_BOOK.get("BOOK_ID") %></a>&nbsp;</td>
