		...
		<db:errors/>
			...
			<db:header>
				...
				<table cellspacing="0" cellpadding="1" width="550">
					<tr bgcolor="#F7A629">
						<td bgcolor="#F7A629"><b>Search Book Name</b></td>
					...
					<tr bgcolor="#BBCCBB">
						...
						<td>
							<input type="checkbox" name="<%= searchFieldAlgorithmNames_BOOK.get("TITLE")%>" size="30" value="weak">Weak.
						</td>
					</tr>
				</table>
				<br>
				<br>
				<table borader="5" width="60%">
					<tr bgcolor="#CCBBCC">
						<td>ID</td>
						<td>ISBN</td>
						<td>AUTHOR ID</td>
